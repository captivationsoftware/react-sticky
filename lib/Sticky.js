...
var Sticky = function (_Component) {
  ...
  function Sticky() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sticky.__proto__ || Object.getPrototypeOf(Sticky)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var topOffset = _this.state.topOffset || _this.props.topOffset;
      var bottomOffset = _this.state.bottomOffset || _this.props.bottomOffset;
      ...
      var isSticky = preventingStickyStateChanges ? wasSticky : (distanceFromTop || 0) <= -topOffset && distanceFromBottom > -bottomOffset;
  ...
  _createClass(Sticky, [{
    ...
    value: function componentDidUpdate() {
      var _state = this.state,
          calculatedHeight = _state.calculatedHeight,
          nonStickyHeight = _state.nonStickyHeight;


      this.placeholder.style.paddingBottom = this.props.disableCompensation ? 0 : (this.state.isSticky ? nonStickyHeight || calculatedHeight : 0) + "px";
    }
  }, {
...
Sticky.propTypes = {
  ...
  hasDifferentNonStickyHeight: _propTypes2.default.bool,
  useHeightForTopOffset: _propTypes2.default.bool,
  useHeightForBottomOffset: _propTypes2.default.bool
};
Sticky.defaultProps = {
  relative: false,
  topOffset: 0,
