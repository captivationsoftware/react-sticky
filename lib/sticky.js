...
class Sticky extends React.Component {
  ...
  componentWillUpdate(props, state, context) {
    this.containerNode = context.containerNode;
  }

  componentDidMount() {
    this.node = ReactDOM.findDOMNode(this);
    this.containerNode = this.context.containerNode;
  ...
  correctBounce(shouldBeSticky) {
    ...
    if (this.containerNode) {
      var paddingTop = (parseInt(this.containerNode.style.paddingTop) || 0) + bounceCorrection;
